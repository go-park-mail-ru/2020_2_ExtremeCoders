...
func (m *MockFileServiceClient) SetAvatar(ctx context.Context, in *fileService.Avatar, opts ...grpc.CallOption) (*fileService.Nothing, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*fileService.Nothing)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockFileServiceClient) GetAvatar(ctx context.Context, in *fileService.User, opts ...grpc.CallOption) (*fileService.Avatar, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockFileServiceClient) SaveFiles(ctx context.Context, in *fileService.Files, opts ...grpc.CallOption) (*fileService.Nothing, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockFileServiceClient) GetFiles(ctx context.Context, in *fileService.LetterId, opts ...grpc.CallOption) (*fileService.Files, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// SetAvatar mocks base method
func (m *MockFileServiceServer) SetAvatar(arg0 context.Context, arg1 *fileService.Avatar) (*fileService.Nothing, error) {
	m.ctrl.T.Helper()
...
// GetAvatar mocks base method
func (m *MockFileServiceServer) GetAvatar(arg0 context.Context, arg1 *fileService.User) (*fileService.Avatar, error) {
	m.ctrl.T.Helper()
...
// SaveFiles mocks base method
func (m *MockFileServiceServer) SaveFiles(arg0 context.Context, arg1 *fileService.Files) (*fileService.Nothing, error) {
	m.ctrl.T.Helper()
...
// GetFiles mocks base method
func (m *MockFileServiceServer) GetFiles(arg0 context.Context, arg1 *fileService.LetterId) (*fileService.Files, error) {
	m.ctrl.T.Helper()
