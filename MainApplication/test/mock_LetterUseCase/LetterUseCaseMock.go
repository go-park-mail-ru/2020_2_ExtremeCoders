...
func (m *MockLetterUseCase) GetSendedLetters(email string, limit, offset uint64) (error, []LetterModel.Letter) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSendedLetters", email, limit, offset)
	ret0, _ := ret[0].(error)
	ret1, _ := ret[1].([]LetterModel.Letter)
	return ret0, ret1
}
...
func (mr *MockLetterUseCaseMockRecorder) GetSendedLetters(email, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSendedLetters", reflect.TypeOf((*MockLetterUseCase)(nil).GetSendedLetters), email, limit, offset)
}

// GetReceivedLettersDir mocks base method
func (m *MockLetterUseCase) GetReceivedLettersDir(dir, limit, offset uint64) (error, []LetterModel.Letter) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReceivedLettersDir", dir, limit, offset)
	ret0, _ := ret[0].(error)
	ret1, _ := ret[1].([]LetterModel.Letter)
	return ret0, ret1
}
...
func (mr *MockLetterUseCaseMockRecorder) GetReceivedLettersDir(dir, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReceivedLettersDir", reflect.TypeOf((*MockLetterUseCase)(nil).GetReceivedLettersDir), dir, limit, offset)
}
...
func (m *MockLetterUseCase) FindSim(sim, email string) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindSim", sim, email)
	ret0, _ := ret[0].(string)
	return ret0
}

// FindSim indicates an expected call of FindSim
func (mr *MockLetterUseCaseMockRecorder) FindSim(sim, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindSim", reflect.TypeOf((*MockLetterUseCase)(nil).FindSim), sim, email)
}

// GetLetterBy mocks base method
func (m *MockLetterUseCase) GetLetterBy(what, val, email string) (error, []LetterModel.Letter) {
	m.ctrl.T.Helper()
...
func (mr *MockLetterUseCaseMockRecorder) GetLetterBy(what, val, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLetterBy", reflect.TypeOf((*MockLetterUseCase)(nil).GetLetterBy), what, val, email)
}

// SetLetterInSpam mocks base method
func (m *MockLetterUseCase) SetLetterInSpam(lid uint64) error {
	m.ctrl.T.Helper()
...
func (mr *MockLetterUseCaseMockRecorder) SetLetterInSpam(lid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetLetterInSpam", reflect.TypeOf((*MockLetterUseCase)(nil).SetLetterInSpam), lid)
}

// SetLetterInBox mocks base method
func (m *MockLetterUseCase) SetLetterInBox(lid uint64) error {
	m.ctrl.T.Helper()
...
func (mr *MockLetterUseCaseMockRecorder) SetLetterInBox(lid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetLetterInBox", reflect.TypeOf((*MockLetterUseCase)(nil).SetLetterInBox), lid)
}
