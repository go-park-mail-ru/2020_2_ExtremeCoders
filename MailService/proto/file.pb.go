...
var file_file_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x64, 0x69, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x3c,
	...
	,
...
var file_file_proto_depIdxs = []int32{
	...
	2, // 4: letterService.LetterService.GetLettersByDir:input_type -> letterService.DirName
	1, // 5: letterService.LetterService.SaveLetter:input_type -> letterService.Letter
	0, // 6: letterService.LetterService.WatchedLetter:input_type -> letterService.Lid
	4, // 7: letterService.LetterService.GetLettersByDir:output_type -> letterService.LetterListResponse
	3, // 8: letterService.LetterService.SaveLetter:output_type -> letterService.Response
	5, // 9: letterService.LetterService.WatchedLetter:output_type -> letterService.LetterResponse
...
type LetterServiceClient interface {
	GetLettersByDir(ctx context.Context, in *DirName, opts ...grpc.CallOption) (*LetterListResponse, error)
...
func (c *letterServiceClient) GetLettersByDir(ctx context.Context, in *DirName, opts ...grpc.CallOption) (*LetterListResponse, error) {
	out := new(LetterListResponse)
	err := c.cc.Invoke(ctx, "/letterService.LetterService/GetLettersByDir", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LetterServiceServer interface {
	GetLettersByDir(context.Context, *DirName) (*LetterListResponse, error)
...
func (*UnimplementedLetterServiceServer) GetLettersByDir(context.Context, *DirName) (*LetterListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLettersByDir not implemented")
}
...
func _LetterService_GetLettersByDir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DirName)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LetterServiceServer).GetLettersByDir(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/letterService.LetterService/GetLettersByDir",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LetterServiceServer).GetLettersByDir(ctx, req.(*DirName))
	}
...
var _LetterService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetLettersByDir",
			Handler:    _LetterService_GetLettersByDir_Handler,
		},
		{
