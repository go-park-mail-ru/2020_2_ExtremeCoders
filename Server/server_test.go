...
func TestServer(t *testing.T) {
	...
	var ans Answer
	var exp Answer
	exp.Code=200;exp.Description="ok"
	err = dec.Decode(&ans)
	if err != nil {
		log.Fatalf(err.Error())
		return
	...
	dec.DisallowUnknownFields()
	exp.Code=400;exp.Description="Do not require request's method, expected POST"
	var ans3 Answer
	err = dec.Decode(&ans3)
	if err != nil {
		log.Fatalf(err.Error())
	...
	dec.DisallowUnknownFields()
	exp.Code=401;exp.Description="not authorized user"
	var ans4 Answer
	err = dec.Decode(&ans4)
	if err != nil {
		log.Fatalf(err.Error())
...
func TestServer2(t *testing.T) {
	...
	var ans Answer
	var exp Answer
	exp.Code=404;exp.Description="Do not find this user in db"
	err = dec.Decode(&ans)
	if err != nil {
		log.Fatalf(err.Error())
		return
...
func TestServer3(t *testing.T) {
	...
	var ans Answer
	var exp Answer
	exp.Code=401;exp.Description="This Email has already exists"
	err = dec.Decode(&ans)
	if err != nil {
		log.Fatalf(err.Error())
		return
